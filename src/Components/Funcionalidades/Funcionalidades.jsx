        ...
        <section className="section3" >
            ...
            <div className="card">
                ...
                <div class="item2">
                    ...
                    <text>
                        Na tela favoritos você pode salvar as receitas que você mais
                        gostou e quer colocar em prática.
                    </text>
                </div>
                <div class="item3">
                    <h1>
                    ...
                    <text>
                        No Perfil, você poderá colocar algumas informações que você
                        gostaria de falar sobre você, sobre culinaria, sua foto etc.
                    </text>
                </div>
                <div class="item4">
                    <h1>
